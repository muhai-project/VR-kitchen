...
3. Start abe_sim
4. Open config.txt and replace the path with the path of your abeSim installation
5. Start VR Kitchen Executable

⚠️ If no Quest headset is connected via Quest Link, the application will crash immediately ⚠️

# Keywords:
Virtual Reality, VR, Human-Robot-Interacction, Human-Robot-Collaboration
# License:
...
WIP
# Requirements:
* Meta Quest 2/3 Headset + Meta Quest Link installed
